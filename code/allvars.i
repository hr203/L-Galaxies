...
# 8 "./code/allvars.h" 2
# 1 "/sw/include/gsl/gsl_rng.h" 1
# 22 "/sw/include/gsl/gsl_rng.h"
...
void *valloc(size_t);
# 23 "/sw/include/gsl/gsl_rng.h" 2
# 1 "/sw/include/gsl/gsl_types.h" 1
# 24 "/sw/include/gsl/gsl_rng.h" 2
# 1 "/sw/include/gsl/gsl_errno.h" 1
# 24 "/sw/include/gsl/gsl_errno.h"
...
# 25 "/sw/include/gsl/gsl_errno.h" 2
# 39 "/sw/include/gsl/gsl_errno.h"
enum {
  GSL_SUCCESS = 0,
  GSL_FAILURE = -1,
  GSL_CONTINUE = -2,
...
# 25 "/sw/include/gsl/gsl_rng.h" 2
# 1 "/sw/include/gsl/gsl_inline.h" 1
# 26 "/sw/include/gsl/gsl_rng.h" 2
# 39 "/sw/include/gsl/gsl_rng.h"
typedef struct
  {
    const char *name;
...
# 9 "./code/allvars.h" 2
# 98 "./code/allvars.h"
extern double SFH_t[68][20][20];
extern double SFH_dt[68][20][20];
extern int SFH_Nbins[68][20][20];
extern int SFH_ibin[68][20];
# 330 "./code/allvars.h"
#pragma pack(1)
...
extern float LumTables[40][4][68][220];
>>>>>>> .r29799
